...
<html>
<head>
	<title>Регистрация в мессенджер</title>
...
<div class="container">
	<div id="signup_form" class="well">
		<h2><center><span class="glyphicon glyphicon-user"></span> Регистрация</center></h2>
		<hr>
		...
		<div style="height: 10px;"></div>
		<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Зарегестрироваться</button> <a href="index.php"> Войти</a>
		</form>
