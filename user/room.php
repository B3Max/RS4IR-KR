		<div class="col-lg-8">
            <div class="panel panel-default" style="height:50px;">
				...
				<div class="showme hidden" style="position: absolute; left:-120px; top:20px; z-index: 3">
					<div class="well">
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<?php
						if ($chatrow['userid']==$_SESSION['id']){
							?>
							<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Главная</a>
							<a href="#delete_room" data-toggle="modal" class="btn btn-danger">Удалить комнату</a>
							<a href="#add_member" data-toggle="modal" class="btn btn-primary">Добавить участника</a>
							<?php
						}
						else{
							?>
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					...
					<span style="font-size:10px; margin-left:10px;"><i>Избегайте использования нецензурной лексики и разжигания ненависти, чтобы избежать блокировки аккаунта</i></span>
					<div style="height:10px;"></div>
				...
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Введите текст..." id="chat_msg">
