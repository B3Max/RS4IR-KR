	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="chatRoom">
        <thead>
            <tr>
				...
				<th>Создан</th>
				<th><span class="glyphicon glyphicon-lock"></span> Пароль || <span class="glyphicon glyphicon-user"></span> Учасники</th>
			</tr>
		</thead>
		<tbody>
		<?php
			...
			<tr>
				...
				<td><button value="<?php echo $row['chatroomid']; ?>" class="btn btn-info join_chat"><span class="glyphicon glyphicon-comment"></span> Войти</button> &nbsp;
					<?php
					if (!empty($row['chat_password'])){
